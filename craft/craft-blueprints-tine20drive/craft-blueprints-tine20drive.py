...
class subinfo(info.infoclass):
    def setTargets(self):
        for ver in ["master-tine20drive"]:
            self.svnTargets[ver] = f"[git]https://github.com/tin20/craft-blueprints-tine20Drive.git|{ver}|"
        self.defaultTarget = "master-tine20drive"
